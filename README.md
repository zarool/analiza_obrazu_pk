...
1. [Struktura programu ](#files)
2. [Potrzebne biblioteki](#dependencies)
3. [Uruchomienie](#usage)
4. [Hardware](#hw)
5. [Opis funkcji w programie](#functions)
6. [Wykorzystanie programu jako biblioteki](https://github.com/zarool/analiza_obrazu_pk/blob/class/README.md)
...
| `system/` | Przyjmuje parametry z terminala (mają defaultowe wartości, nie są niezbędne) oraz zbiera informacje na temat tego, czy zewnętrzna kamera występuje - jeżeli nie, to wychwyci obraz z kamerki z laptopa                                        |
| `args.py` |                                                                                                                                                                                                                                               |
...
Tryby działania kamery IMX219 użytej w programie. Tryb zmienia rozdzielczość oraz ilość klatek przechwytywanego orbazu.
...
| Nazwa funkcji         | Opis                                                                                                                                                                                                             |
|-----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `set_exposure(value)` | Zmiana ekspozycji kamery, wymaga restartu, dlatego znajduje się w głównym programie                                                                                                                              |
