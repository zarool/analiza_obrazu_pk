...
def gstreamer_pipeline( 
    ...
    # GStreamer is an open-source multimedia framework mainly used to 
    # create media applications (streaming, media playback, non-linear 
    # editing, etc.). The GStreamer framework is designed to make writing 
    # applications that handle audio or video easy. It uses plugins that 
    # will provide various codecs and other functionalities  
...
class Camera(object):
    ...
    def open_camera(self, width=640, height=360):
        ...
        self.cap = cv2.VideoCapture(gstreamer_str, cv2.CAP_GSTREAMER)#gstreamer_pipeline(flip_method=0, display_width=width, display_height=height), cv2.CAP_GSTREAMER)
