    ...
    while True:
        ...
        try:
            ...
            if funkcja == 'KOLOR':
                ...
                detektory_watki[str(wartosc)] = (threading.Thread(target=detektory[str(wartosc)].Detekcja_Koloru,args=(magazyn, str(wartosc))))  ### Tworzenie watku
                ...
                kamera = Camera_Maszt() # tworzymy obiekt kamery
                kamera.flag = False
                #kamera.show = True
                # uruchamiamy wtek odpowiedzialny za akwizycje obrazu
                t1 = threading.Thread(target=Camera_Maszt.Camera_Maszt_Akwizycja, args=(kamera, magazyn))
                t1.start()
                time.sleep(0.2)
            ...
            print("blad dekodowania - rozpoznawanie") 
            print(e)